...
./build/dev-debug/battle_server.exe --config configs/battle_server.conf --check
./build/dev-debug/demo_flow.exe --login-config configs/login_server.conf --player-config configs/player_server.conf --battle-config configs/battle_server.conf
